...
RSpec.describe Browet::Category do
  ...
  context "when correct config" do
    ...
    it "responds to get 1" do
      should_be_category_1 Browet::Category.get('category1')
    end

    it "responds to get 2" do
      should_be_category_2 Browet::Category.get('category2')
    end

    it "responds to get 3" do
      should_be_category_3 Browet::Category.get('category3')
    end
    ...
    it "has category 1 containing products" do
      should_be_unpaged_set Browet::Category.get('category1').products
    end

    it "has category 1 containing paged products" do
      should_be_paged_set Browet::Category.get('category1').products(2, 2)
    end
  end
